...
const serializedATN = [4,1,68,472,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,
...
export default class JassParser extends antlr4.Parser {
    ...
    static ruleNames = [ "start", "chunk", "block", "stat", "attnamelist", 
	...
	start() {
	    ...
	    this.enterRule(localctx, 0, JassParser.RULE_start);
	    try {
	...
	chunk() {
	    ...
	    this.enterRule(localctx, 2, JassParser.RULE_chunk);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 55;
	        this.block();
	...
	block() {
	    ...
	    this.enterRule(localctx, 4, JassParser.RULE_block);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 60;
	...
	stat() {
	    ...
	    this.enterRule(localctx, 6, JassParser.RULE_stat);
	    var _la = 0;
	    try {
	        this.state = 147;
	        this._errHandler.sync(this);
	        ...
	        case 5:
	            ...
	            this.state = 73;
	            this.match(JassParser.BREAK);
	            break;

	        case 6:
	            this.enterOuterAlt(localctx, 6);
	            this.state = 74;
	            this.match(JassParser.GOTO);
	            this.state = 75;
	            this.match(JassParser.NAME);
	            break;

	        case 7:
	            this.enterOuterAlt(localctx, 7);
	            this.state = 76;
	            this.match(JassParser.DO);
	            this.state = 77;
	            this.block();
	            this.state = 78;
	            this.match(JassParser.END);
	            break;

	        case 8:
	            this.enterOuterAlt(localctx, 8);
	            this.state = 80;
	            this.match(JassParser.WHILE);
	            this.state = 81;
	            this.exp(0);
	            this.state = 82;
	            this.match(JassParser.DO);
	        ...
	        case 9:
	            ...
	            this.state = 86;
	            this.match(JassParser.REPEAT);
	            this.state = 87;
	            this.block();
	            this.state = 88;
	            this.match(JassParser.UNTIL);
	            this.state = 89;
	            this.exp(0);
	            break;
	...
	attnamelist() {
	    ...
	    this.enterRule(localctx, 8, JassParser.RULE_attnamelist);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 149;
	...
	attrib() {
	    ...
	    this.enterRule(localctx, 10, JassParser.RULE_attrib);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 162;
	...
	retstat() {
	    ...
	    this.enterRule(localctx, 12, JassParser.RULE_retstat);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 170;
	        ...
	        case 22:
	            this.state = 169;
	            this.match(JassParser.CONTINUE);
	            break;
	        default:
	...
	label() {
	    ...
	    this.enterRule(localctx, 14, JassParser.RULE_label);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 175;
	        this.match(JassParser.CC);
	        this.state = 176;
	        this.match(JassParser.NAME);
	        this.state = 177;
	        this.match(JassParser.CC);
	...
	funcname() {
	    ...
	    this.enterRule(localctx, 16, JassParser.RULE_funcname);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 179;
	...
	varlist() {
	    ...
	    this.enterRule(localctx, 18, JassParser.RULE_varlist);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 191;
	...
	namelist() {
	    ...
	    this.enterRule(localctx, 20, JassParser.RULE_namelist);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 199;
	        this.match(JassParser.NAME);
	...
	explist() {
	    ...
	    this.enterRule(localctx, 22, JassParser.RULE_explist);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 207;
	...
	exp(_p) {
	    ...
	    this.enterRecursionRule(localctx, 24, JassParser.RULE_exp, _p);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 227;
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 1:
	                    ...
	                    this.pushNewRecursionContext(localctx, _startState, JassParser.RULE_exp);
	                    this.state = 229;
	...
	var_() {
	    ...
	    this.enterRule(localctx, 26, JassParser.RULE_var);
	    try {
	        this.state = 268;
	        this._errHandler.sync(this);
	        ...
	        case 2:
	            ...
	            case 48:
	                this.state = 260;
	                this.match(JassParser.OB);
	                this.state = 261;
	                this.exp(0);
	                this.state = 262;
	                this.match(JassParser.CB);
	                break;
	            case 27:
	                this.state = 264;
	                this.match(JassParser.DOT);
	...
	prefixexp() {
	    ...
	    this.enterRule(localctx, 28, JassParser.RULE_prefixexp);
	    try {
	        this.state = 308;
	        this._errHandler.sync(this);
	        ...
	        case 3:
	            this.enterOuterAlt(localctx, 3);
	            this.state = 294;
	            this.match(JassParser.OP);
	            this.state = 295;
	            this.exp(0);
	            this.state = 296;
	            this.match(JassParser.CP);
	            this.state = 305;
	            this._errHandler.sync(this);
	...
	functioncall(_p) {
	    ...
	    this.enterRecursionRule(localctx, 30, JassParser.RULE_functioncall, _p);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 373;
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 1:
	                    ...
	                    this.pushNewRecursionContext(localctx, _startState, JassParser.RULE_functioncall);
	                    this.state = 375;
	                    if (!( this.precpred(this._ctx, 5))) {
	                        throw new antlr4.error.FailedPredicateException(this, "this.precpred(this._ctx, 5)");
	                    }
	...
	args() {
	    ...
	    this.enterRule(localctx, 32, JassParser.RULE_args);
	    var _la = 0;
	    try {
	        this.state = 415;
	        this._errHandler.sync(this);
	...
	functiondef() {
	    ...
	    this.enterRule(localctx, 34, JassParser.RULE_functiondef);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 417;
	        this.match(JassParser.FUNCTION);
	...
	funcbody() {
	    ...
	    this.enterRule(localctx, 36, JassParser.RULE_funcbody);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 420;
	        this.match(JassParser.OP);
	...
	parlist() {
	    ...
	    this.enterRule(localctx, 38, JassParser.RULE_parlist);
	    var _la = 0;
	    try {
	        this.state = 433;
	        this._errHandler.sync(this);
	...
	tableconstructor() {
	    ...
	    this.enterRule(localctx, 40, JassParser.RULE_tableconstructor);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 435;
	        this.match(JassParser.OCU);
	        this.state = 437;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	...
	fieldlist() {
	    ...
	    this.enterRule(localctx, 42, JassParser.RULE_fieldlist);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 441;
	...
	field() {
	    ...
	    this.enterRule(localctx, 44, JassParser.RULE_field);
	    try {
	        this.state = 463;
	        this._errHandler.sync(this);
	...
	fieldsep() {
	    ...
	    this.enterRule(localctx, 46, JassParser.RULE_fieldsep);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 465;
	...
	number() {
	    ...
	    this.enterRule(localctx, 48, JassParser.RULE_number);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 467;
	...
	string() {
	    ...
	    this.enterRule(localctx, 50, JassParser.RULE_string);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 469;
...
JassParser.LT = 19;
JassParser.GT = 20;
JassParser.RETURN = 21;
JassParser.CONTINUE = 22;
JassParser.CC = 23;
JassParser.NIL = 24;
JassParser.FALSE = 25;
JassParser.TRUE = 26;
...
JassParser.SQEQ = 56;
JassParser.NAME = 57;
JassParser.NORMALSTRING = 58;
JassParser.CHARSTRING = 59;
JassParser.LONGSTRING = 60;
JassParser.INT = 61;
JassParser.HEX = 62;
JassParser.FLOAT = 63;
JassParser.HEX_FLOAT = 64;
JassParser.COMMENT = 65;
JassParser.WS = 66;
JassParser.NL = 67;
JassParser.SHEBANG = 68;

JassParser.RULE_start = 0;
JassParser.RULE_chunk = 1;
JassParser.RULE_block = 2;
JassParser.RULE_stat = 3;
JassParser.RULE_attnamelist = 4;
JassParser.RULE_attrib = 5;
JassParser.RULE_retstat = 6;
JassParser.RULE_label = 7;
JassParser.RULE_funcname = 8;
JassParser.RULE_varlist = 9;
JassParser.RULE_namelist = 10;
JassParser.RULE_explist = 11;
JassParser.RULE_exp = 12;
JassParser.RULE_var = 13;
JassParser.RULE_prefixexp = 14;
JassParser.RULE_functioncall = 15;
JassParser.RULE_args = 16;
JassParser.RULE_functiondef = 17;
JassParser.RULE_funcbody = 18;
JassParser.RULE_parlist = 19;
JassParser.RULE_tableconstructor = 20;
JassParser.RULE_fieldlist = 21;
JassParser.RULE_field = 22;
JassParser.RULE_fieldsep = 23;
JassParser.RULE_number = 24;
JassParser.RULE_string = 25;
...
class StartContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_start;
    }
...
class ChunkContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_chunk;
    }
...
class BlockContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_block;
    }
...
class StatContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_stat;
    }

	SEMI() {
	    return this.getToken(JassParser.SEMI, 0);
	};
	...
	BREAK() {
	    return this.getToken(JassParser.BREAK, 0);
	};

	GOTO() {
	    return this.getToken(JassParser.GOTO, 0);
	};

	NAME() {
	    return this.getToken(JassParser.NAME, 0);
	};

	DO() {
	    return this.getToken(JassParser.DO, 0);
	};
	...
	END() {
	    return this.getToken(JassParser.END, 0);
	};

	WHILE() {
	    return this.getToken(JassParser.WHILE, 0);
	};
	...
	REPEAT() {
	    return this.getToken(JassParser.REPEAT, 0);
	};

	UNTIL() {
	    return this.getToken(JassParser.UNTIL, 0);
	};
	...
	THEN = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.THEN);
	    } else {
	        return this.getToken(JassParser.THEN, i);
	    }
	};
	...
	ELSEIF = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.ELSEIF);
	    } else {
	        return this.getToken(JassParser.ELSEIF, i);
	    }
	};
	...
	FOR() {
	    return this.getToken(JassParser.FOR, 0);
	};
	...
	IN() {
	    return this.getToken(JassParser.IN, 0);
	};
...
class AttnamelistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_attnamelist;
    }
	...
	NAME = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.NAME);
	    } else {
	        return this.getToken(JassParser.NAME, i);
	    }
	};
...
class AttribContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_attrib;
    }
...
class RetstatContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_retstat;
    }
	...
	CONTINUE() {
	    return this.getToken(JassParser.CONTINUE, 0);
	};
...
class LabelContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_label;
    }
	...
	CC = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.CC);
	    } else {
	        return this.getToken(JassParser.CC, i);
	    }
	};
...
class FuncnameContext extends antlr4.ParserRuleContext {
	...
	DOT = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.DOT);
	    } else {
	        return this.getToken(JassParser.DOT, i);
	    }
	};


	COL() {
	    return this.getToken(JassParser.COL, 0);
	};
...
class VarlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_varlist;
    }
...
class NamelistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_namelist;
    }
...
class ExplistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_explist;
    }
...
class ExpContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_exp;
    }

	NIL() {
	    return this.getToken(JassParser.NIL, 0);
	};
	...
	DDD() {
	    return this.getToken(JassParser.DDD, 0);
	};
	...
	POUND() {
	    return this.getToken(JassParser.POUND, 0);
	};
	...
	SQUIG() {
	    return this.getToken(JassParser.SQUIG, 0);
	};

	CARET() {
	    return this.getToken(JassParser.CARET, 0);
	};

	STAR() {
	    return this.getToken(JassParser.STAR, 0);
	};

	SLASH() {
	    return this.getToken(JassParser.SLASH, 0);
	};

	PER() {
	    return this.getToken(JassParser.PER, 0);
	};

	SS() {
	    return this.getToken(JassParser.SS, 0);
	};
	...
	DD() {
	    return this.getToken(JassParser.DD, 0);
	};
	...
	LE() {
	    return this.getToken(JassParser.LE, 0);
	};

	GE() {
	    return this.getToken(JassParser.GE, 0);
	};

	SQEQ() {
	    return this.getToken(JassParser.SQEQ, 0);
	};

	EE() {
	    return this.getToken(JassParser.EE, 0);
	};
	...
	AMP() {
	    return this.getToken(JassParser.AMP, 0);
	};

	PIPE() {
	    return this.getToken(JassParser.PIPE, 0);
	};

	LL() {
	    return this.getToken(JassParser.LL, 0);
	};

	GG() {
	    return this.getToken(JassParser.GG, 0);
	};
...
class VarContext extends antlr4.ParserRuleContext {
	...
	OB() {
	    return this.getToken(JassParser.OB, 0);
	};
	...
	CB() {
	    return this.getToken(JassParser.CB, 0);
	};

	DOT() {
	    return this.getToken(JassParser.DOT, 0);
	};
...
class PrefixexpContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_prefixexp;
    }
	...
	OB = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.OB);
	    } else {
	        return this.getToken(JassParser.OB, i);
	    }
	};
	...
	CB = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(JassParser.CB);
	    } else {
	        return this.getToken(JassParser.CB, i);
	    }
	};
	...
	OP() {
	    return this.getToken(JassParser.OP, 0);
	};

	CP() {
	    return this.getToken(JassParser.CP, 0);
	};
...
class FunctioncallContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_functioncall;
    }
...
class FunctiondefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_functiondef;
    }
...
class ParlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_parlist;
    }
	...
	COMMA() {
	    return this.getToken(JassParser.COMMA, 0);
	};
...
class TableconstructorContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_tableconstructor;
    }

	OCU() {
	    return this.getToken(JassParser.OCU, 0);
	};

	CCU() {
	    return this.getToken(JassParser.CCU, 0);
	};
...
class FieldlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_fieldlist;
    }
...
class FieldContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_field;
    }
...
class FieldsepContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_fieldsep;
    }
...
class NumberContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_number;
    }
	...
	HEX_FLOAT() {
	    return this.getToken(JassParser.HEX_FLOAT, 0);
	};
...
class StringContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = JassParser.RULE_string;
    }

	NORMALSTRING() {
	    return this.getToken(JassParser.NORMALSTRING, 0);
	};

	CHARSTRING() {
	    return this.getToken(JassParser.CHARSTRING, 0);
	};

	LONGSTRING() {
	    return this.getToken(JassParser.LONGSTRING, 0);
	};
...
JassParser.StartContext = StartContext; 
JassParser.ChunkContext = ChunkContext; 
JassParser.BlockContext = BlockContext; 
JassParser.StatContext = StatContext; 
JassParser.AttnamelistContext = AttnamelistContext; 
JassParser.AttribContext = AttribContext; 
JassParser.RetstatContext = RetstatContext; 
JassParser.LabelContext = LabelContext; 
JassParser.FuncnameContext = FuncnameContext; 
JassParser.VarlistContext = VarlistContext; 
JassParser.NamelistContext = NamelistContext; 
JassParser.ExplistContext = ExplistContext; 
JassParser.ExpContext = ExpContext; 
JassParser.VarContext = VarContext; 
JassParser.PrefixexpContext = PrefixexpContext; 
JassParser.FunctioncallContext = FunctioncallContext; 
JassParser.ArgsContext = ArgsContext; 
JassParser.FunctiondefContext = FunctiondefContext; 
JassParser.FuncbodyContext = FuncbodyContext; 
JassParser.ParlistContext = ParlistContext; 
JassParser.TableconstructorContext = TableconstructorContext; 
JassParser.FieldlistContext = FieldlistContext; 
JassParser.FieldContext = FieldContext; 
JassParser.FieldsepContext = FieldsepContext; 
JassParser.NumberContext = NumberContext; 
JassParser.StringContext = StringContext; 
